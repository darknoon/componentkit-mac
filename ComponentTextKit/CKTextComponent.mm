...
{
  CK::Component::MountResult result = [super mountInContext:context layout:layout supercomponent:supercomponent];
...
#else
  view.accessibilityElement = _accessibilityContext.isAccessibilityElement.boolValue;
#endif
